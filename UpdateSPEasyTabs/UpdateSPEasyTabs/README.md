# Create a SharePoint Farm with 3 VMs using the Powershell DSC Extension

This template will create a SharePoint 2013 Farm (latest update), with an additional SQL Server 2014, using the PowerShell DSC Extension it creates the following resources:
